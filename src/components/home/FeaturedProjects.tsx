...
const statusConfig = {
  completed: {
    label: "Completed",
    className: "bg-primary-900/60 text-primary-400 border-primary-700/40",
  },
  "in-progress": {
    label: "In Progress",
    className: "bg-amber-900/60 text-amber-400 border-amber-700/40",
  },
  archived: {
    label: "Archived",
    className: "bg-gray-900/60 text-gray-400 border-gray-700/40",
  },
};
      ...
      >
        ...
        <div className="p-5 space-y-4 flex flex-col flex-1">
          ...
          <div className="flex items-center justify-between">
            <span
              className={`text-xs px-2 py-0.5 rounded-full font-medium border ${status.className}`}
            >
              {status.label}
            </span>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-[#f0fdfa] mb-4">
            Featured{" "}
            <span className="text-primary-400 glow-text">Projects</span>
          </h2>
          <p className="text-primary-200/60 max-w-xl mx-auto">
            A selection of personal and portfolio projects that demonstrate my
            experience in enterprise systems, system integration, and DevOps
            automation
          </p>
